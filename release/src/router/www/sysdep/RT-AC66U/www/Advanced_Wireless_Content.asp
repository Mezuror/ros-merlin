...
function initial(){
	...
	if(band5g_support && band5g_11ac_support && document.form.wl_unit[1].selected == true){ //AC 5G
		...
		else if(based_modelid == "R6300_V2" || based_modelid == "DSL-AC68U" || based_modelid == "RT-AC68U" || based_modelid == "RT-AC68U_V2" || based_modelid == "RT-AC69U" || 
	...
	if(country == "EU"){		//display checkbox of DFS channel under 5GHz
		if(based_modelid == "R6300_V2" || based_modelid == "RT-AC68U" || based_modelid == "RT-AC68U_V2" || based_modelid == "DSL-AC68U" || based_modelid == "RT-AC69U"
		...
		if(based_modelid == "R6300_V2" || based_modelid == "RT-AC68U" || based_modelid == "RT-AC68U_V2" || based_modelid == "RT-AC69U" || based_modelid == "DSL-AC68U"
	...
	if(document.form.wl_nmode_x.value == 2){
		...
		if(tmo_support){
			...
			if (!band5g_11ac_support){	//for RT-N66U SDK 6.x
				...
				based_modelid == "RT-AC66U" || 
				based_modelid == "RT-AC3200" || 
				based_modelid == "RT-AC3100" || based_modelid == "RT-AC88U" ||
